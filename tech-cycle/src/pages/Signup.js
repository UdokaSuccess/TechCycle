  ...
  <div className='signup-col2'>
     ...
     <h2>Create Account</h2>
        <label className='label'>Full Name: <input type='text' name='name' required placeholder='Enter your full Name'/></label>
         ...
         <label className='label'>Password: <input type='password' name='password' required placeholder='Enter Your Password'/></label>
         <label className='label'>Confirm Password: <input type='password' name='password' required placeholder='Confirm Your Password'/></label>
